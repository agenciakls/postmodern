...
<!--	<link href="https://fonts.googleapis.com/css?family=Raleway:100,100i,200,200i,300,300i,400,400i,500,500i,600,600i,700,700i,800,800i,900,900i&amp;subset=latin-ext" rel="stylesheet">-->
	...
	<link rel="stylesheet" href="<?php echo baseUrl(); ?>css/style.css?v=1.1.5" type="text/css" />
	...
	<div class="collapse bg-dark" id="navbarHeader">
		<div id="navbarList">
			<ul class="list-unstyled">
				...
				<li><a href="<?php echo baseUrl(); ?>agendamento" class="text-white">Novo Pedido</a></li>
...
<section class="jumbotron text-center header-slogan no-print" style="background-image: url(<?php echo baseUrl(); ?>images/background_05.jpg) !important;">
	<div class="container">
