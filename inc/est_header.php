			...
			<ul class="nav">
				...
				<li>
					...
					<ul class="submenu">
						...
						<li><a href="<?php echo baseUrl(); ?>servicos/itunes">Apple Digital Masters e Streaming</a></li>
				...
				if (isset($usuarioAtual)) {
					?>
					<li><a href="<?php echo baseUrl(); ?>conta"><i class="fa fa-user-circle"></i> Conta</a></li>
					<?php 
				}
				else {
					?>
