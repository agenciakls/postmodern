		...
		while ($impPedidos = fetchData($pegarDados)) {
			...
			<div class="row">
				<div class="col-lg-6">
					...
					<p><strong>Pagamento: </strong> <?php echo $impPedidos['pagamento_status']; ?></p>
					<p>
									...
									<tbody>
										...
										while ( $impFileCl = fetchData( $fileClientes ) ) {
											...
											<tr>
												...
												<td><a href="<?php echo $impFileCl['url']; ?>" download><i class="fas fa-download"></i> Baixar</a></td>
											</tr>
											<?php
										}
										?>
...
?>
<script src="<?php echo baseUrl(); ?>js/script_admin_pedido.js"></script>