				...
				<div class="col-md-12 pn-inside">
					...
					if ( $quantidade == 1 ) {
						while ( $impPedido = fetchData( $pegarPedido ) ) {
							...
							<div class="row">
								<div class="col-md-12">
									<p>Obrigado por escolher Post Modern Mastering para Masterizar o projeto <?php echo $impPedido['artista']; ?> e <?php echo $impPedido['projeto']; ?> com André Dias.</p>
									...
									if ($impPedido['pagamento_status'] == 1 || $impPedido['pagamento_status'] == 4) {
										?>
										<p>Abaixo estão os métodos de pagamento disponíveis:</p>
										<div class="row">
											<div class="col-md-6">
												<h5 class="card-title">PayPal e Cartão de Crédito</h5>
											...
											<div class="col-md-6">
												<div class="list-payment">
													<div class="item-payment" id="boleto">
														<h5 class="card-title">Transferência Bancária ou PIX</h5>
														<p><strong>Banco:</strong> Bradesco</p>
														<p><strong>Agência:</strong> AG 2359 </p>
														<p><strong>C/C:</strong> 411982-7</p>
														<p><strong>Nome:</strong> André Luiz de Andrade Dias</p>
														<p><strong>CPF:</strong> 033.620.147-80</p>
														<p><small>Ao efetuar uma transferência notifique ao engenheiro.</small></p>
													</div>
												</div>
											</div>
										</div>
