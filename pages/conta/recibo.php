            ...
            <div class="main-content">
                ...
                <div class="content-divider jumbotron my-3 py-3">
                    ...
                    <p>
                        ...
                        Data e Horário: <?= strftime("%d/%m/%Y - %H:%M", strtotime($impPedido['data'])); ?>
                    ...
                    <span class="no-print">
                        <a href=javascript:print();><button class="btn-post">Imprimir Ordem</button></a>
                    </span>
                ...
                <div class="content-divider jumbotron my-3 py-3">
                    <div class="content-divider-in">
                        ...
                        <div align="right" class="order-money-totals">
                            <p><b>Total:</b> R$ <span class="total"><?php echo number_format($totalFinal, 2, ',', '.') ?></span></p>
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
                ...
                <span class="no-print">
                    <a href="<?php echo baseUrl(); ?>conta/pedido?p=<?php echo $idPedido; ?>"><button class="btn-post">Voltar</button></a>
                </span>
