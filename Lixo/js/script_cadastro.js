...
$('.field-mix').on('keyup', function ( e ) {
	...
	var setTotal = setMixes + setVersions + setVinyl;
	$("#set-mixes").html('R$ ' + setMixes + ',00');
	$("#set-versions").html('R$ ' + setVersions + ',00');
	$("#set-vinyl").html('R$ ' + setVinyl + ',00');
	$("#set-total").html('R$ ' + setTotal + ',00');
	$("#show-total").html('R$ ' + setTotal + ',00');
